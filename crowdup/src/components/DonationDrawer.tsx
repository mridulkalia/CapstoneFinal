        ...
        >
            <Container>
                <Stack>
                    ...
                    />
                    <Paper {...paperProps}>
                        <Text fw={500}>Tip CrisisChain services</Text>
                        <Text size="sm" my="xs">CrisisChain has a 0% platform fee for organizers. CrisisChain will continue
                    ...
                    <Paper {...paperProps}>
                        <Stack>
                            <Text size="sm">By continuing, you agree with <Anchor>CrisisChain terms</Anchor> and <Anchor>privacy
                                notice.</Anchor></Text>
                            ...
                            <Flex gap="sm">
                                ...
                                <Text size="sm">We guarantee you a full refund for up to a year in the rare case that
                                    fraud occurs.&nbsp;<Anchor>See our CrisisChain Giving Guarantee.</Anchor>
                                </Text>
                            </Flex>
                        </Stack>
                    </Paper>
