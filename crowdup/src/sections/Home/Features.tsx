...
const mockdata = [
  ...
  },
  {
    ...
    title: "Education",
    description: `Make your social enterprise (or “dream project”) a reality. Learn the keys to success and avoid the common missteps through one of our programs, working alongside other founders.`,
  ...
  },
  {
    ...
    title: "Crowdfunding",
    description: `Ready to rally the resources you need to do good? CrisisChain offers project, recurring and debt crowdfunding. We can even help you design a great campaign to give you the highest chance to succeed!`,
  ...
  },
  {
    ...
    title: "Partnerships",
    description: `CrisisChain partners with leading brands, institutions and governments to support changemakers. We accelerate change through challenges, accelerators and funding programs.`,
    // action: "Find out how we can work together ",
  },
];

function Feature({ image, title, description }: FeatureProps) {
...
const FeaturesSection = ({ boxProps, subtitleProps }: IProps) => {
  ...
  return (
    <Box {...boxProps}>
      <Box mb="lg">
        <TitleBadge title="Future Endeavors" />
        <Text {...subtitleProps}>
          CrisisChain exists to support social impact projects, enterprises and
